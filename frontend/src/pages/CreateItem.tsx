...
const CreateItem = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-32 bg-green-50">
            <h2 className="text-3xl font-bold text-green-800 mb-6">Add New Item</h2>
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {['calories', 'protein', 'carbs', 'fiber', 'sugar'].map((nutrient) => (
                                <div key={nutrient}>
                ...
                <div className="mt-6 slide-in-left">
